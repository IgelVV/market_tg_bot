...
Если у Вас возникли дополнительные вопросы, вы можете связаться с \
администратором @{admin_username}.
...
DISPLAY_PAY_MENU = "Выберите вариант подписки"

PAYMENT_TITLE = "Плата за подписку"
PAYMENT_DESCRIPTION ="Оплачивая подписку Вы получаете " \
                     "доступ к управлению магазином."
PAYMENT_LABEL_PRICE = "Подписка"
PAYMENT_WRONG_PAYLOAD_ERROR = "Что-то пошло не так..."
PAYMENT_SUCCESS = "Вы успешно оплатили подписку 🎉."
